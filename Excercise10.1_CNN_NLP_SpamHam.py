# -*- coding: utf-8 -*-
"""
Created on Wed Jul 22 08:01:38 2020
...
#Create the model
D = 20 #Embedding layer depth, aka feature vector length
...
#fit the model
model_history = model.fit(X_train, y_train, epochs=10, validation_data=
                          (X_test, y_test))
